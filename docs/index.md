...
described in [Täuber et al. (in
prep.)](https://dx.doi.org/10.2139/ssrn.6366401) The crown
...
If you want to install the first version of `coi` which was used in
[Täuber et al. (in prep.)](https://dx.doi.org/10.2139/ssrn.6366401),
run:
